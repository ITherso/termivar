...
pub(super) enum ResourceAuthorizationRuntimeInvariantError {
    ...
    Evidence(#[from] venom_core::ReasoningModelError),
...
fn append_phase_evidence(
    ...
    evidence.push(direct(
        ...
        venom_core::HttpEvidencePredicate::RESPONSE_BODY_BYTES_OBSERVED.into_knowledge(),
    ...
    parents.push(
        evidence
            ...
            .find(|item| {
                item.predicate()
                    == &venom_core::HttpEvidencePredicate::RESPONSE_BODY_BYTES_OBSERVED
                        .into_knowledge()
            })
