...
use termivar_core::{EntityId, Outcome, OutcomeStatus, VerificationStage};
use thiserror::Error;
...
///
/// ```rust
/// use termivar_scanner::{ExperiencePolicy, ExperienceStore};
///
...
mod tests {
    ...
    use termivar_core::{EvidenceId, Probability};
