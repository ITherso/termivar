//! Ordered scan phases for the historical `termivar legacy-scan` pipeline.
//!
//! ## Runtime scope
//!
//! - **Build:** non-default `legacy-scanner` feature.
//! - **Execution:** Surface A — the mixed-authority ordered sequence composed
//!   for `termivar legacy-scan`. Phases 2–4 use a bounded passive discovery
...
//! - **Default `termivar scan`:** no. Within `legacy-scan`, `DirectoryFuzzer` is
