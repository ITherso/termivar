...
//! resource before it constructs an [`termivar_core::ApiVisibilityObservation`].
...
mod tests {
            ...
            .register(
                ReasoningRule::new(
                    ...
                    HypothesisConclusion::new(
                        ...
                        Probability::from_percent(10).unwrap(),
                        termivar_core::HypothesisStrength::Weak,
    ...
    fn resource_projection_is_stable_and_ignores_noncanonical_relations() {
        ...
        knowledge
            .upsert_relation(termivar_core::KnowledgeRelation::new(
                unrelated_subject,
                resource(),
    ...
    fn rejected_relations_consume_the_page_scan_budget() {
        ...
        knowledge
            .upsert_relation(termivar_core::KnowledgeRelation::with_id(
    ...
    fn oversized_relation_is_rejected_before_it_can_reach_review_projection() {
        let knowledge = KnowledgeBase::new();
        let relation = termivar_core::KnowledgeRelation::with_id(
