...
use termivar_core::{ConceptId, EvidenceId, EvidenceValue, KnowledgePredicate, RelationTypeId};
...
///
/// ```rust
/// use termivar_core::{EvidenceValue, KnowledgePredicate};
/// use termivar_scanner::{Expression, KnowledgeLayer};
///
