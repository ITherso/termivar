...
#[cfg(feature = "supplied-session-review")]
#[derive(Serialize)]
struct SuppliedSessionCookiePolicyRecord {
    declared_count: u8,
    host_only_count: u8,
    domain_count: u8,
    secure_count: u8,
...
#[cfg(feature = "supplied-session-review")]
#[derive(Serialize)]
struct SuppliedSessionCookieLifecycleRecord {
    initial_epoch: u8,
    final_epoch: u8,
    ...
    fn from_audit(audit: &WebAssessmentSuppliedSessionAudit) -> Self {
        ...
        Self {
            ...
            cookie_lifecycle: audit.cookie_lifecycle().map(|lifecycle| {
                SuppliedSessionCookieLifecycleRecord {
...
fn outcome_status_code(status: termivar_scanner::OutcomeStatus) -> &'static str {
    match status {
        termivar_scanner::OutcomeStatus::Success => "success",
        termivar_scanner::OutcomeStatus::Blocked => "blocked",
        termivar_scanner::OutcomeStatus::Unknown => "unknown",
        termivar_scanner::OutcomeStatus::FalsePositive => "false_positive",
        termivar_scanner::OutcomeStatus::NeedsReview => "needs_review",
        termivar_scanner::OutcomeStatus::ConfirmedNegative => "confirmed_negative",
        _ => "other",
    }
}
...
"#,
    ...
    fn additive_json_has_distinct_schema_and_typed_profile() {
        ...
        assert_eq!(
            ...
            termivar_scanner::web_runtime::SCAN_PROFILE_V1_SCHEMA
        );
    ...
    fn stable_reason_and_status_vocabularies_cover_every_current_runtime_boundary() {
        ...
        let outcomes = [
            ...
            (termivar_scanner::OutcomeStatus::Unknown, "unknown"),
            (
                termivar_scanner::OutcomeStatus::FalsePositive,
                "false_positive",
            ),
            (termivar_scanner::OutcomeStatus::NeedsReview, "needs_review"),
            (
                termivar_scanner::OutcomeStatus::ConfirmedNegative,
                "confirmed_negative",
            ),
        ];
