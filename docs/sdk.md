...
This is a Preview source-level SDK. Compatibility follows the [Plugin API and SemVer policy](plugin-api-policy.md) until a broader framework policy is versioned.
