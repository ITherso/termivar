...
| Semantic ledger digest | waf-evasion-salvage-sha256:ce26aba8311def8a0eb58fa33e0aa7d286a1723b9b850f9f19eb9ce9a6f2679a |
| Prior source-epoch digest | salvage-sha256:cd706569ed6044cc99b97bb55322a6651b271fa233a66651cd8b477625e63843 |
...
| waf.case-variation | crates/venom-scanner/src/waf.rs | rewrite-from-contract | p0 | restored | venom-scanner:normalization-resilience | crates/venom-scanner/src/payload_strategies/normalization_resilience_query_pair.rs, crates/venom-scanner/src/web_runtime/web_assessment/normalization_transform_catalog.rs | generic-string-mutation, misleading-bypass-claim | V1 restores only typed scanner-owned HTML token case with exact semantic verification and replay; identity values and target-controlled text remain unchanged. |
...
| waf.whitespace-variation | crates/venom-scanner/src/waf.rs | rewrite-from-contract | p0 | restored | venom-scanner:normalization-resilience | crates/venom-scanner/src/payload_strategies/normalization_resilience_query_pair.rs, crates/venom-scanner/src/web_runtime/web_assessment/normalization_transform_catalog.rs | generic-string-mutation, crlf-injection, misleading-bypass-claim | V1 restores only one typed scanner-owned HTML horizontal separator with DOM semantic verification and replay; generic string-wide whitespace mutation remains prohibited. |
